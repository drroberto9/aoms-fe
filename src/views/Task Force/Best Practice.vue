  ...
  <div>
    ...
    <md-card style="padding: 15px 20px;">
      ...
      >
            ...
            <md-card style="margin: 10px 0 0 0; padding: 10px">
              ...
              >
                <div class="md-layout">
                  ...
                  <div class="md-layout-item" style="max-width: max-content">
                    <md-button
                      v-if="filterByOffice(row.item.office_id)"
                      v-b-tooltip.hover
                      title="Delete"
                      class="md-icon-button md-dense md-accent"
                      @click="
        ...
        <template #cell(actions)="row">
          <div v-if="filterByOffice(row.item.office_id)">
            <md-button
              v-b-tooltip.hover
              title="Attach File"
              class="md-icon-button md-dense md-primary"
...
export default {
  ...
  methods: {
    ...
    submit() {
      let office_id = this.officeSelect.office_id;
    ...
    filterByOffice(id) {
      if (id) {
        if (this.offices.find(item => item.office_id === id)) return true;
      }
    },
    concatName(item) {
